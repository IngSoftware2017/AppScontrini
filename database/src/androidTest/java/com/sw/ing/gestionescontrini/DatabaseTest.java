...
public class DatabaseTest {
    ...
    public void createTicket1AndInsert(){
        ...
        testTicketEntity1.setAmountTicket(new BigDecimal(12));
        ...
        testTicket2.setAmountTicket(new BigDecimal(12));
    ...
    public void insertTicketAmountTest(){
        Assert.assertTrue(ticketDAO.getAllTickets().get(0).getAmountTicket().equals(testTicketEntity1.getAmountTicket()));
    }
    @Test
    ...
    public void updateTicketShouldNullEmptyFields(){
        ...
        Assert.assertNull(emptyTicketEntity.getAmountTicket());
    }
