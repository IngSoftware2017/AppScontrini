...
public class WordMatcher {
    ...
    public double match(OcrText line) {
        ...
        int wordsLeastLoss = min(Stream.of(line.childs())
                .map(w -> levDistance(compiledRegex, w.textAlphaNumeric(), maxDist)).toList());
        ...
        int finalLoss = min(wordsLeastLoss, levDistance(compiledRegex, line.textAlphaNumeric(), maxDist));
