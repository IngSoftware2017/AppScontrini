...
public class OcrVars {
    ...
    static final String LEFT_TAG = "left"; //tag for rawtext on left of the receipt
    static final String CENTER_TAG = "center"; //tag for rawtext on center of the receipt
    static final String RIGHT_TAG = "right"; //tag for rawtext on right of the screen
